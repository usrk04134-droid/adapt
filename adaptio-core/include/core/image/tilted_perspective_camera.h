...
class TiltedPerspectiveCameraProperties : public CameraProperties {
 public:
  core::scanner::ScannerCalibrationData config_calib;
  core::scanner::Fov config_fov;

  static auto FromUnorderedMap(const std::unordered_map<std::string, core::data::DataValue> &map)
