...
class Naive : public JointModel {
 public:
  Naive(const JointProperties& properties, const core::scanner::ScannerConfigurationData& config_data,
 ...
 protected:
   ...
   */
  [[nodiscard]] auto GetJointArea(core::image::WorkspaceCoordinates centroids, const PwlWedge& pwl_wedge) -> double;
   ...
   */
  [[nodiscard]] auto GrooveLine(std::optional<core::image::WorkspaceCoordinates> centroids) const
   ...
   */
  auto GetImprovedSurfaceLine(const core::image::WorkspaceCoordinates& laser_line, const LineSegment& line_segment,
 ...
 private:
  auto GetBottomCentroids(const core::image::Image& image, const LineSegment& left_groove_wall,
  ...
  auto GetWallImage(std::vector<std::tuple<int, int>>& wall_coords_image, const core::image::RawImageData& image,
  ...
  boost::circular_buffer<core::scanner::PwlWedge> wedge_buffer_;
