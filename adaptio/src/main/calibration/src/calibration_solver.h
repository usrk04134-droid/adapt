...
struct Observation {
  common::groove::Point slide_position;
  std::vector<lpcs::Point> abw_points_lpcs;
};

struct TorchPlaneInfo {
  // Observation laser_plane_observation;
  common::groove::Point top_center_at_torch_plane;
  common::groove::Point bottom_center_at_torch_plane;
};
...
struct CalibrationResult {
  ...
  // Quality metrics
  common::groove::Point torch_plane_reference;
  std::vector<common::groove::Point> projected_points;
  double max_residual;
