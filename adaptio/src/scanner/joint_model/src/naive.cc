...
auto Naive::Parse(image::Image& image, std::optional<JointProfile> median_profile,
  ...
  std::optional<common::Groove> maybe_abw_points;
  ...
  previous_left_edge  = abw_points[0].horizontal;
  previous_right_edge = abw_points[6].horizontal;

  auto left_groove_wall_height  = abw_points[0].horizontal - abw_points[1].horizontal;
  auto right_groove_wall_height = abw_points[6].horizontal - abw_points[5].horizontal;
  ...
  return std::make_tuple(profile, line, processing_time, num_walls_found);
}
...
auto Naive::ExtractABWPoints(const PwlWedge& pwl_wedge, const LineSegment& groove_bottom)
    -> std::optional<common::Groove> {
  ...
  LOG_INFO(
      ...
      ABW6[0], ABW6[1]);
  common::Groove points = {
      common::Point{ABW0[0], ABW0[1]},
      common::Point{ABW1[0], ABW1[1]},
      common::Point{ABW2[0], ABW2[1]},
      common::Point{ABW3[0], ABW3[1]},
      common::Point{ABW4[0], ABW4[1]},
      common::Point{ABW5[0], ABW5[1]},
      common::Point{ABW6[0], ABW6[1]}
  };
...
auto Naive::ExtractABWPointsCapWeldingMode(const std::optional<LineSegment> maybe_left_wall,
                                           ...
                                           const image::WorkspaceCoordinates& joint) -> std::optional<common::Groove> {
  ...
  common::Point abw0 = common::Point{x0, y0};
  common::Point abw1 = common::Point{x1, y1};
  common::Point abw2 = common::Point{x2, y2};
  common::Point abw3 = common::Point{x3, y3};
  common::Point abw4 = common::Point{x4, y4};
  common::Point abw5 = common::Point{x5, y5};
  common::Point abw6 = common::Point{x6, y6};
  ...
  common::Groove points = {abw0, abw1, abw2, abw3, abw4, abw5, abw6};
