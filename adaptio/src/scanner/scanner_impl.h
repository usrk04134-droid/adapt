...
auto const WINDOW_MARGIN_X      = 200;
auto const MOVE_MARGIN_X        = 80;
auto const MINIMUM_FOV_WIDTH    = 2000;
...
class ScannerImpl : public Scanner {
 ...
 private:
  ...
  std::optional<int> dont_allow_horizontal_change_until_new_width_received;
