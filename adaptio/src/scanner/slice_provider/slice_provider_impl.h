...
class SliceProviderImpl : public SliceProvider {
 public:
  ...
  auto GetTrackingSlice()
      -> std::optional<std::tuple<common::Groove, std::vector<common::Point>, SliceConfidence, uint64_t>> override;
 ...
 private:
  ...
  std::tuple<common::Groove, std::vector<common::Point>, SliceConfidence> latest_slice_;
